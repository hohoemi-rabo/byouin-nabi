...
### Context/State管理
- [ ] QuestionnaireContext の作成
- [ ] 回答データの型定義（TypeScript）
- [ ] 状態管理ロジックの実装

### アンケートコンポーネント
- [ ] QuestionnaireForm コンポーネント作成
- [ ] QuestionOption コンポーネント作成（選択肢）
- [ ] 各質問項目の実装
  - [ ] Q1: どこが気になりますか？（単一選択）
  - [ ] Q2: いつからですか？（単一選択）
  - [ ] Q3: どんな状態ですか？（複数選択）
...
### ルーティング
- [ ] /questionnaire ページの作成
- [ ] /questionnaire から /results への遷移

...
### テンプレートエンジン実装
- [x] 症状説明文生成関数の作成
- [x] テンプレートリテラルでの文章組み立て
- [x] 条件分岐ロジックの実装

### API ルート作成
- [x] `/api/symptoms/generate` エンドポイント作成
- [x] リクエストバリデーション
- [x] エラーハンドリング

### 結果表示コンポーネント
- [x] SymptomDescription コンポーネント作成
- [x] 生成された文章の表示
- [x] 免責事項の表示
- [x] コピー機能（オプション）
...
## 受け入れ基準
- [x] アンケート回答から症状説明文が正しく生成される
- [x] 全てのセクションが適切にフォーマットされる
- [x] 条件分岐（しこりの大きさなど）が正しく動作する
- [x] 免責事項が必ず表示される
